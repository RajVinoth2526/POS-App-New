...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function _src_app_appRoutingModuleTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var dashboard_component_1 = __webpack_require__(
    /*! ./components/dashboard/dashboard.component */
    "./src/app/components/dashboard/dashboard.component.ts");

    var add_product_component_1 = __webpack_require__(
    /*! ./components/add-product/add-product.component */
    "./src/app/components/add-product/add-product.component.ts");

    var sales_order_component_1 = __webpack_require__(
    /*! ./components/sales-order/sales-order.component */
    "./src/app/components/sales-order/sales-order.component.ts");

    var settings_component_1 = __webpack_require__(
    ...
    var routes = [{
      ...
      path: 'sales-order-process',
      component: sales_order_component_1.SalesOrderComponent
    }, {
      path: 'settings',
  ...
  /***/
  function _src_app_appComponentTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(settingsService, spinner) {
      ...
      return _createClass(AppComponent, [{
        ...
        value: function getThemeSettings() {
          ...
          this.spinner.show();
          this.settingsService.getAllSystemThemeSettings().subscribe(function (response) {
            _this.spinner.hide();

            var themes = response.data;
            var theme = (themes === null || themes === void 0 ? void 0 : themes[0]) || environment_1.environment.defaultThemeSettings;

            _this.settingsService.updateThemeSettingsValue(theme);
    ...
    AppComponent.ɵfac = function AppComponent_Factory(t) {
      return new (t || AppComponent)(i0.ɵɵdirectiveInject(i1.SystemService), i0.ɵɵdirectiveInject(i2.NgxSpinnerService));
    };
    ...
    AppComponent.ɵcmp = i0.ɵɵdefineComponent({
      ...
      decls: 5,
      vars: 1,
      consts: [[1, "app-container"], ["bdColor", "rgba(51,51,51,0.8)", "size", "medium", "color", "#fff", "type", "ball-scale-multiple", 3, "fullScreen"]],
      ...
      directives: [i3.HeaderComponent, i4.RouterOutlet, i5.FooterComponent, i2.NgxSpinnerComponent],
  ...
  /***/
  function _src_app_appModuleTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var product_list_component_1 = __webpack_require__(
    /*! ./components/product-list/product-list.component */
    "./src/app/components/product-list/product-list.component.ts");

    var cart_component_1 = __webpack_require__(
    ...
    AppModule.ɵinj = i0.ɵɵdefineInjector({
      ...
      providers: [],
      imports: [[platform_browser_1.BrowserModule, app_routing_module_1.AppRoutingModule, forms_1.ReactiveFormsModule, http_1.HttpClientModule, forms_1.FormsModule, animations_1.BrowserAnimationsModule, ngx_spinner_1.NgxSpinnerModule]]
    });

    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(AppModule, {
        declarations: [app_component_1.AppComponent, product_list_component_1.ProductListComponent, cart_component_1.CartComponent, dashboard_component_1.DashboardComponent, header_component_1.HeaderComponent, footer_component_1.FooterComponent, add_product_component_1.AddProductComponent, sales_order_component_1.SalesOrderComponent, settings_component_1.SettingsComponent],
        imports: [platform_browser_1.BrowserModule, app_routing_module_1.AppRoutingModule, forms_1.ReactiveFormsModule, http_1.HttpClientModule, forms_1.FormsModule, animations_1.BrowserAnimationsModule, ngx_spinner_1.NgxSpinnerModule]
      });
    })();
    /*@__PURE__*/
  ...
  /***/
  function _src_app_components_addProduct_addProductComponentTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var AddProductComponent = /*#__PURE__*/function () {
      ...
      return _createClass(AddProductComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
        ...
        value: function onFileChange(event) {
          ...
          if (file) {
            ...
            this.productForm.patchValue({
              image: file
            }); // Optionally, store the file in the form control
          }
        }
      }, {
        key: "onSubmit",
        value: function onSubmit() {
          if (this.productForm.valid) {
            var newProduct = {
              ...
              price: this.productForm.value.price //Assuming you want to store the image URL

            };
            this.productService.addProduct(newProduct).subscribe(function (response) {
    ...
    AddProductComponent.ɵcmp = i0.ɵɵdefineComponent({
      type: AddProductComponent,
      selectors: [["app-add-product"]],
      decls: 50,
      vars: 4,
      consts: [[1, "add-product-container"], [1, "add-product-title"], [1, "add-product-container-scroll"], [1, "shadow", "p-4", "rounded-lg", "bg-white", 3, "formGroup", "ngSubmit"], [1, "form-group"], ["for", "productName", 1, "font-weight-bold"], ["type", "text", "id", "productName", "formControlName", "name", "placeholder", "Enter product name", "required", "", 1, "form-control", "form-control-lg"], ["for", "productDescription", 1, "font-weight-bold"], ["id", "productDescription", "formControlName", "description", "placeholder", "Enter product description", "rows", "4", "required", "", 1, "form-control", "form-control-lg"], ["for", "productPrice", 1, "font-weight-bold"], ["type", "number", "id", "productPrice", "formControlName", "price", "placeholder", "Enter product price", "required", "", 1, "form-control", "form-control-lg"], ["for", "productImage", 1, "font-weight-bold"], ["type", "file", "id", "productImage", 1, "form-control-file", 3, "change"], ["class", "form-group", 4, "ngIf"], [1, "form-group", "text-center"], ["type", "submit", 1, "btn", "btn-primary", "btn-lg", "px-4", "py-2", "mt-3", 3, "disabled"], [1, "font-weight-bold"], ["alt", "Image Preview", "width", "150", "height", "150", 1, "img-fluid", "rounded", "shadow-sm", 3, "src"]],
      ...
      directives: [i2.ɵangular_packages_forms_forms_y, i2.NgControlStatusGroup, i2.FormGroupDirective, i2.DefaultValueAccessor, i2.NgControlStatus, i2.FormControlName, i2.RequiredValidator, i2.NumberValueAccessor, i3.NgIf],
    ...
    (function () {
      i0.ɵsetClassMetadata(AddProductComponent, [{
        type: core_1.Component,
        args: [{
  ...
  /***/
  function _src_app_components_cart_cartComponentTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    function CartComponent_ng_template_5_tr_18_Template(rf, ctx) {
      if (rf & 1) {
        ...
        i0.ɵɵlistener("click", function CartComponent_ng_template_5_tr_18_Template_button_click_8_listener() {
          i0.ɵɵrestoreView(_r7);
          var i_r5 = ctx.index;
          var ctx_r6 = i0.ɵɵnextContext(2);
          return ctx_r6.increaseQuantity(i_r5);
        });
        i0.ɵɵtext(9, " \u25B2 ");
        i0.ɵɵelementEnd();
        ...
        i0.ɵɵlistener("click", function CartComponent_ng_template_5_tr_18_Template_button_click_12_listener() {
          i0.ɵɵrestoreView(_r7);
          var i_r5 = ctx.index;
          var ctx_r8 = i0.ɵɵnextContext(2);
          return ctx_r8.decreaseQuantity(i_r5);
        });
        i0.ɵɵtext(13, " \u25BC ");
        i0.ɵɵelementEnd();
        i0.ɵɵelementEnd();
        ...
        i0.ɵɵlistener("click", function CartComponent_ng_template_5_tr_18_Template_button_click_17_listener() {
          i0.ɵɵrestoreView(_r7);
          var i_r5 = ctx.index;
          var ctx_r9 = i0.ɵɵnextContext(2);
          return ctx_r9.removeFromCart(i_r5);
        });
    ...
    CartComponent.ɵcmp = i0.ɵɵdefineComponent({
      type: CartComponent,
      selectors: [["app-cart"]],
      inputs: {
        cart: "cart"
    ...
    (function () {
      i0.ɵsetClassMetadata(CartComponent, [{
        type: core_1.Component,
        args: [{
          selector: 'app-cart',
  ...
  /***/
  function _src_app_components_dashboard_dashboardComponentTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    function DashboardComponent_div_2_Template(rf, ctx) {
      if (rf & 1) {
        ...
        i0.ɵɵlistener("click", function DashboardComponent_div_2_Template_div_click_1_listener() {
          i0.ɵɵrestoreView(_r3);
          var item_r1 = ctx.$implicit;
          var ctx_r2 = i0.ɵɵnextContext();
          return ctx_r2.navigateTo(item_r1.route);
        });
    ...
    DashboardComponent.ɵcmp = i0.ɵɵdefineComponent({
      type: DashboardComponent,
      selectors: [["app-dashboard"]],
      decls: 3,
      vars: 1,
      consts: [[1, "container", "my-5"], [1, "row"], ["class", "col-md-3 mb-4", 4, "ngFor", "ngForOf"], [1, "col-md-3", "mb-4"], [1, "card", "text-center", "shadow-sm", "h-100", "dashboard-card", 3, "click"], [1, "card-body", "d-flex", "flex-column", "justify-content-center", "align-items-center"], [3, "ngStyle"], [1, "card-title"]],
    ...
    (function () {
      i0.ɵsetClassMetadata(DashboardComponent, [{
        type: core_1.Component,
        args: [{
  ...
  /***/
  function _src_app_components_footer_footerComponentTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    FooterComponent.ɵcmp = i0.ɵɵdefineComponent({
      ...
      decls: 4,
      vars: 0,
      consts: [[1, "bg-dark", "text-white", "text-center", "py-3", "mt-auto"], [1, "container"]],
      template: function FooterComponent_Template(rf, ctx) {
        if (rf & 1) {
          i0.ɵɵelementStart(0, "footer", 0);
          i0.ɵɵelementStart(1, "div", 1);
          i0.ɵɵelementStart(2, "small");
          i0.ɵɵtext(3, "\xA9 2025 MyPOS App. All rights reserved.");
          i0.ɵɵelementEnd();
          i0.ɵɵelementEnd();
          i0.ɵɵelementEnd();
        }
  ...
  /***/
  function _src_app_components_header_headerComponentTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    HeaderComponent.ɵcmp = i0.ɵɵdefineComponent({
      ...
      decls: 4,
      vars: 0,
      consts: [[1, "navbar", "navbar-expand-lg", "shadow-sm", "pos-header"], [1, "container-fluid"], ["href", "#", 1, "navbar-brand", "fw-bold", 2, "color", "white"]],
  ...
  /***/
  function _src_app_components_productList_productListComponentTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    function ProductListComponent_div_8_Template(rf, ctx) {
      if (rf & 1) {
        ...
        i0.ɵɵlistener("click", function ProductListComponent_div_8_Template_button_click_8_listener() {
          i0.ɵɵrestoreView(_r3);
    ...
    ProductListComponent.ɵcmp = i0.ɵɵdefineComponent({
      ...
      template: function ProductListComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          })("input", function ProductListComponent_Template_input_input_5_listener() {
            return ctx.onSearch();
          });
          i0.ɵɵelementEnd();
          i0.ɵɵelementEnd();
      ...
      directives: [i1.DefaultValueAccessor, i1.NgControlStatus, i1.NgModel, i2.NgForOf],
      encapsulation: 2
    });
    /*@__PURE__*/

    (function () {
      i0.ɵsetClassMetadata(ProductListComponent, [{
        type: core_1.Component,
        args: [{
  ...
  /***/
  function _src_app_components_salesOrder_salesOrderComponentTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var SalesOrderComponent = /*#__PURE__*/function () {
      ...
      return _createClass(SalesOrderComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "addToCart",
    ...
    SalesOrderComponent.ɵfac = function SalesOrderComponent_Factory(t) {
      return new (t || SalesOrderComponent)();
    };

    SalesOrderComponent.ɵcmp = i0.ɵɵdefineComponent({
      type: SalesOrderComponent,
      selectors: [["app-sales-order"]],
      decls: 5,
      vars: 1,
      consts: [[1, "row"], [1, "col-md-6"], [3, "add"], [3, "cart", "cartChange"]],
      template: function SalesOrderComponent_Template(rf, ctx) {
        if (rf & 1) {
          i0.ɵɵelementStart(0, "div", 0);
          i0.ɵɵelementStart(1, "div", 1);
          i0.ɵɵelementStart(2, "app-product-list", 2);
          i0.ɵɵlistener("add", function SalesOrderComponent_Template_app_product_list_add_2_listener($event) {
          ...
          i0.ɵɵlistener("cartChange", function SalesOrderComponent_Template_app_cart_cartChange_4_listener($event) {
            return ctx.cart = $event;
          });
          i0.ɵɵelementEnd();
          i0.ɵɵelementEnd();
          i0.ɵɵelementEnd();
      ...
      directives: [i1.ProductListComponent, i2.CartComponent],
    ...
    (function () {
      i0.ɵsetClassMetadata(SalesOrderComponent, [{
        type: core_1.Component,
        args: [{
  ...
  /***/
  function _src_app_components_settings_settingsComponentTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var i2 = tslib_1.__importStar(__webpack_require__(
    /*! src/app/service/system.service */
    "./src/app/service/system.service.ts"));
    ...
    var SettingsComponent = /*#__PURE__*/function () {
      function SettingsComponent(fb, systemSettings, spinnerService) {
      ...
      return _createClass(SettingsComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.systemSettings.themeSettings$.subscribe(function (data) {
            if (data == null) return;
            _this3.themeForm = _this3.fb.group({
        ...
        key: "onApplyTheme",
        value: function onApplyTheme() {
          var _this4 = this;

          var _a, _b;

          var theme = this.themeForm.value; // If theme exists, update, otherwise create a new one

          if ((_a = this.systemSettings.getCurrentThemeSettingsValue()) === null || _a === void 0 ? void 0 : _a.id) {
            // Update the theme settings
            this.spinnerService.show();
            this.systemSettings.updateThemeSettings((_b = this.systemSettings.getCurrentThemeSettingsValue()) === null || _b === void 0 ? void 0 : _b.id, theme).subscribe(function (response) {
              if (response.success) {
                _this4.applyThemeValue(response.data); // Use the data from response
            ...
            this.spinnerService.show();
            this.systemSettings.createThemeSettings(theme).subscribe(function (response) {
              if (response.success) {
                _this4.spinnerService.hide();
        ...
        key: "applyThemeValue",
        value: function applyThemeValue(theme) {
          // Update the theme settings
          this.systemSettings.updateThemeSettingsValue(theme); // Apply theme styles dynamically to the document
    ...
    SettingsComponent.ɵcmp = i0.ɵɵdefineComponent({
      ...
      template: function SettingsComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          i0.ɵɵlistener("ngSubmit", function SettingsComponent_Template_form_ngSubmit_77_listener() {
            return ctx.onApplyTheme();
          });
          ...
          i0.ɵɵlistener("click", function SettingsComponent_Template_button_click_117_listener() {
            return ctx.onResetTheme();
          });
      ...
      directives: [i1.ɵangular_packages_forms_forms_y, i1.NgControlStatusGroup, i1.NgForm, i1.NgSelectOption, i1.ɵangular_packages_forms_forms_x, i1.FormGroupDirective, i1.DefaultValueAccessor, i1.NgControlStatus, i1.FormControlName, i1.SelectControlValueAccessor],
    ...
    (function () {
      i0.ɵsetClassMetadata(SettingsComponent, [{
        type: core_1.Component,
        args: [{
        ...
        return [{
          ...
          type: i2.SystemService
        }, {
          type: i3.NgxSpinnerService
        }];
      }, null);
    })();
    /***/
  ...
  /***/
  function _src_app_service_productServiceTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var ProductService = /*#__PURE__*/function () {
      function ProductService(http) {
        ...
        this.http = http; // Set the backend URL here
    ...
    ProductService.ɵprov = i0.ɵɵdefineInjectable({
    ...
    (function () {
      i0.ɵsetClassMetadata(ProductService, [{
  ...
  /***/
  function _src_app_service_systemServiceTs(module, exports, __webpack_require__) {
    "use strict";
    ...
    var SystemService = /*#__PURE__*/function () {
      ...
      return _createClass(SystemService, [{
        key: "updateThemeSettingsValue",
        value: function updateThemeSettingsValue(settings) {
          this.themeSettingsSubject.next(settings);
        } // Optionally get the current value

      }, {
        key: "getCurrentThemeSettingsValue",
        value: function getCurrentThemeSettingsValue() {
          return this.themeSettingsSubject.value;
        } // GET: Get theme settings by ID

      }, {
        key: "getThemeSettings",
        value: function getThemeSettings(id) {
          return this.http.get("".concat(environment_1.environment.apiUrl, "api/system/theme-settings/").concat(id));
        } // Create new theme settings

      }, {
        key: "createThemeSettings",
        value: function createThemeSettings(data) {
          return this.http.post("".concat(environment_1.environment.apiUrl, "api/system/theme-settings"), data);
        } // Update existing theme settings

      }, {
        key: "updateThemeSettings",
        value: function updateThemeSettings(id, data) {
          return this.http.patch("".concat(environment_1.environment.apiUrl, "api/system/theme-settings/").concat(id), data);
        }
      }, {
        key: "getAllSystemThemeSettings",
        value: function getAllSystemThemeSettings() {
          return this.http.get("".concat(environment_1.environment.apiUrl, "api/system/theme-settings"));
        } // GET: getProfileData

      }, {
        key: "getProfileData",
        value: function getProfileData(id) {
          return this.http.get("".concat(environment_1.environment.apiUrl, "api/system/profile/").concat(id));
        } // createProfile

      }, {
        key: "createProfile",
        value: function createProfile(data) {
          return this.http.post("".concat(environment_1.environment.apiUrl, "api/system/profile"), data);
        } // updateProfile

      }, {
        key: "updateProfile",
        value: function updateProfile(id, data) {
          return this.http.patch("".concat(environment_1.environment.apiUrl, "api/system/profile/").concat(id), data);
        } // getAllProfile

      }, {
        key: "getAllProfile",
        value: function getAllProfile() {
          return this.http.get("".concat(environment_1.environment.apiUrl, "api/system/profile"));
        }
      }]);
    }();
    ...
    SystemService.ɵfac = function SystemService_Factory(t) {
      return new (t || SystemService)(i0.ɵɵinject(i1.HttpClient));
    };

    SystemService.ɵprov = i0.ɵɵdefineInjectable({
      token: SystemService,
    ...
    (function () {
      i0.ɵsetClassMetadata(SystemService, [{
        type: core_1.Injectable,
        args: [{
          providedIn: 'root'
        }]
  ...
  /***/
  function _src_environments_environmentTs(module, exports, __webpack_require__) {
  ...
  /***/
  function _src_mainTs(module, exports, __webpack_require__) {
    "use strict";
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! D:\pos_sytem\pos-app\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
